      ...
      <div className="w-full max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-stretch">
        ...
        <div className="w-full lg:w-3/5 relative h-[600px] lg:h-[calc(100vh)]">
          ...
          <img
            src={bgLogo}
            alt="Background Logo"
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-10 px-[10px] sm:px-0 box-content w-[90vw] max-w-[350px] sm:w-[600px] sm:max-w-[600px] md:w-[800px] md:max-w-[800px] lg:w-[889px] lg:max-w-none h-auto"
          />
        ...
        {/* Right Side: Form */}
        <div className="w-full lg:w-2/5 flex items-center justify-center -mt-12 p-6 md:p-12 z-20">
            ...
            <div className="flex space-x-4">
              <div className="w-1/2">
                ...
                <div className="relative">
                  <select
                    id="userType"
                    className="w-full p-3 bg-[#181818] text-white border border-white/20 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-red-500"
                  >
